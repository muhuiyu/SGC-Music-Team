  ...
  return (
    <div>
      <aside
        ...
        aria-label="Sidebar"
      >
        {/* <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6 max-w-[250px]"></div> */}
            ...
            <div className="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200">
              <ul className="pb-2 space-y-2">
                ...
                <li>
                  ...
                  <ul id="dropdown-crud" className="hidden space-y-2 py-2">
                    <li>
                      <a
                        href=""
                        className="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 "
                      >
                        Products
                      </a>
                    </li>
                ...
                <li>
                  ...
                  <ul id="dropdown-playground" className="hidden space-y-2 py-2">
                    <li>
                      <a
                        href=""
                        className="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 "
