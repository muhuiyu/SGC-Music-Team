      ...
      <div className="relative w-full h-full max-w-md px-4 md:h-auto">
        <div className="relative bg-white rounded-lg shadow ">
          ...
          <div className="p-6 pt-0 text-center">
            ...
            <a
              href="#"
              className="text-gray-900 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-indigo-300 border border-gray-200 font-medium inline-flex items-center rounded-lg text-base px-3 py-2.5 text-center   "
              data-modal-toggle="delete-user-modal"
            >
              No, cancel
            </a>
