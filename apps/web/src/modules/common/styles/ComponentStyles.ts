// PageContent
export const pageHeaderStyle = 'col-span-full pb-4 px-2'
export const pageContentDivStyle = 'flex flex-col gap-4 px-2'
export const pageContentDashboardDivStyle = 'flex flex-row gap-4 px-2'

// Detail page
export const detailPageHeaderDivStyle = 'flex flex-row pl-10'
export const detailPageInfoDivStyle = 'flex-1 py-6 border-t border-gray-100'
export const detailPageInfoTitleStyle = 'text-sm font-medium leading-6 text-gray-900'
export const detailPageInfoContentStyle = 'mt-1 text-sm leading-6 text-gray-700 sm:mt-2'
export const detailPageTextFieldLabelStyle = 'block mb-2 text-sm font-medium text-gray-900'
...
export const detailPageRowStyle = 'flex flex-row px-10'
